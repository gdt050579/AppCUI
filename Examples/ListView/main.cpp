...
public:
    SelectionDemo()
    {
        ...
        inf.Create(this, "Use SHIFT+Up/Down/Home/End/PageUp/PageDown to select an item.\nAlternatively you can use Insert to select an item and move to the next one.", "x:1,y:1,w:66,h:3");
    }
};
