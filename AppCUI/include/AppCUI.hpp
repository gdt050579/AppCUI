...
namespace OS
{
    ...
    typedef bool (*EnumerateFilesCallback)(
          const char* fullPath, const char* Name, unsigned long long size, bool Folder, void* Context);
    typedef bool (*CopyFileCallback)(
          const char* source,
          const char* destination,
          unsigned long long copiedBytesSoFar,
    ...
    namespace FileSystem
    {
        ...
        constexpr std::initializer_list<SpecialFolder> AllSpecialFolders = {
            SpecialFolder::Home,   SpecialFolder::Desktop, SpecialFolder::DriveA, SpecialFolder::DriveB,
            SpecialFolder::DriveC, SpecialFolder::DriveD,  SpecialFolder::DriveE, SpecialFolder::DriveF,
            SpecialFolder::DriveG, SpecialFolder::DriveH,  SpecialFolder::DriveI, SpecialFolder::DriveJ,
            SpecialFolder::DriveK, SpecialFolder::DriveL,  SpecialFolder::DriveM, SpecialFolder::DriveN,
            SpecialFolder::DriveO, SpecialFolder::DriveP,  SpecialFolder::DriveQ, SpecialFolder::DriveR,
            SpecialFolder::DriveS, SpecialFolder::DriveT,  SpecialFolder::DriveU, SpecialFolder::DriveV,
            SpecialFolder::DriveW, SpecialFolder::DriveX,  SpecialFolder::DriveY, SpecialFolder::DriveZ,
        };
        namespace Path
        {
        ...
        EXPORT bool EnumerateFiles(
              AppCUI::Utils::String& path,
              bool recursive,
              EnumerateFilesCallback callback,
              void* Context,
              bool callFolderCallbackAfterProcessingAllOfItsFiles = false);
        EXPORT bool EnumerateFiles(
              const char* path,
              bool recursive,
              EnumerateFilesCallback callback,
        ...
        EXPORT bool DeleteFolder(
              AppCUI::Utils::String& name,
              bool failIfFileIsMissing    = false,
              DeleteFileCallback callback = nullptr,
              void* Context               = nullptr);
        EXPORT bool DeleteFolder(
              const char* name,
              bool failIfFileIsMissing    = false,
        ...
        EXPORT bool CopyFile(
              const char* source,
              const char* destination,
              CopyFileCallback callback = nullptr,
              void* Context             = nullptr);
    }; // namespace FileSystem
