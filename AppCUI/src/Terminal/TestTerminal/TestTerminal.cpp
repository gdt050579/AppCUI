...
bool TestTerminal::ResizeConsoleBuffer(uint32 width, uint32 height)
{
...
bool TestTerminal::CopyOriginalScreenBuffer(uint32 width, uint32 height, uint32 mouseX, uint32 mouseY)
{
...
bool TestTerminal::ResizeConsoleScreenBufferSize(uint32 width, uint32 height)
{
    COORD coord = { 0, 0 };
    coord.X     = (SHORT) width;
...
bool TestTerminal::ResizeConsoleWindowSize(uint32 width, uint32 height)
{
    SMALL_RECT rect;
...
Size TestTerminal::MaximizeTerminal()
{
...
Size TestTerminal::FullScreenTerminal()
{
    COORD coord = { 0, 0 };
...
Size TestTerminal::ResizeTerminal(const InitializationData& initData, const Size& currentSize)
{
...
Size TestTerminal::UpdateTerminalSize(const InitializationData& initData, const Size& currentSize)
{
    Size resultedSize;
...
bool TestTerminal::ComputeCharacterSize(const Application::InitializationData& initData)
{
...
void TestTerminal::BuildKeyTranslationMatrix()
{
