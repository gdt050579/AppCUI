...
bool CanvasViewer::Create(Control* parent, const char * layout, unsigned int canvasWidth, unsigned int canvasHeight, ViewerFlags flags)
{
    return this->Create(parent, "", layout, canvasWidth, canvasHeight, flags);
}
bool CanvasViewer::Create(Control* parent, const char * title, const char * layout, unsigned int canvasWidth, unsigned int canvasHeight, ViewerFlags flags)
{
    ...
    Members->Flags = GATTR_ENABLE | GATTR_VISIBLE | GATTR_TABSTOP | GATTR_VSCROLL| GATTR_HSCROLL | ((unsigned int)flags);
