...
bool WindowsConsoleRenderer::OnInit()
{
...
void WindowsConsoleRenderer::OnUninit()
{

}
void WindowsConsoleRenderer::OnFlushToScreen()
{
...
bool WindowsConsoleRenderer::OnUpdateCursor()
{
    if (Cursor.Visible)
    {
